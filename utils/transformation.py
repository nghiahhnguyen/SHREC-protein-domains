...
class SamplePoints(object):
    ...
    def __init__(self, num, remove_faces=True, include_normals=False, use_original=False):
        self.num = num
    ...
    def __call__(self, data):
        ...
        if self.use_original:
            ...
            if "features" in locals():
                ...
                features_sampled += frac[:, :1] * feat_vec1
                features_sampled += frac[:, 1:] * feat_vec2
                pos_sampled = torch.cat(
                    [pos_sampled, features_sampled], dim=-1)
