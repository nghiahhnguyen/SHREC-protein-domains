# mkdir data
python3 main.py --face-to-edge 0 --meshes-to-points 1 --model edge_conv --layer dynamic_edge_conv --set-x 0 --lr 0.005 --num-instances 10 --num-sample-points 512 --in-memory-dataset --batch-size 8 --nhid 256 --load-latest --mode submit --use-txt
